...
namespace ImGui
{
    ...
    IMGUI_API void          TextSeparator(ImU32 col, const char* text);
    ...
    IMGUI_API bool          Checkbox1(const char* label, const char* hint_label, bool* v);
    ...
    IMGUI_API bool          BeginCombo(const char* label, const char* hint_label, const char* preview_value, ImGuiComboFlags flags = 0);

    IMGUI_API void          EndCombo();
    IMGUI_API bool          Combo(const char* label, const char* hint_label, int* current_item, bool(*items_getter)(void*, int, const char**), void* data, int items_count, int popup_max_height_in_items);

    IMGUI_API bool          Combo(const char* label, const char* hint_label, int* current_item, const char* const items[], int items_count, int height_in_items);

    IMGUI_API bool          Combo(const char* label, const char* hint_label, int* current_item, const char* items_separated_by_zeros, int height_in_items);

    IMGUI_API void          MultiCombo(const char* label, const char* hint_label, bool variable[], const char* labels[], int count);
    ...
    IMGUI_API bool          ColorEdit3(const char* label, const char* hint_label, float col[3], ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          ColorEdit4(const char* label, const char* hint_label, float col[4], ImGuiColorEditFlags flags = 0);
