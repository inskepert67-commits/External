...
//#endif
    ...
    IMGUI_API bool          Keybind(const char* label, const char* hint_label, int* key);
    ...
    IMGUI_API bool          Tabs(bool selected, const char* ico, const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
